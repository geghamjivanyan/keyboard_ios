...
#ifndef KEYBOARDHOST_SWIFT_H
#define KEYBOARDHOST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KeyboardHost",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12KeyboardHost11AppDelegate")
...
@class UIScene;
SWIFT_CLASS("_TtC12KeyboardHost13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC12KeyboardHost14ViewController")
